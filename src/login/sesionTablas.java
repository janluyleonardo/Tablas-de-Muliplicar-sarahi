...
//        }
        ...
        lblRespuestaCorrecta.setVisible(false); lblRespuestaIncorrecta.setVisible(false);
    ...
    private void initComponents() {
        ...
        jpTablas.add(lblRespuestaCorrecta, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 600, 380));
        ...
        jpTablas.add(lblRespuestaIncorrecta, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 600, 470));
    ...
    private void btnIgualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIgualActionPerformed
        ...
        if(txtRespuesta.getText().equals("") ){
            ...
            if(respuesta == contador){
                ...
                lblAnuncio.setText("<html><center>!!! RESPUESTA CORRECTA<br>FELICITACIONES¡¡¡</center></html>");
                btnRegresar.setVisible(true);
                lblRespuestaCorrecta.setVisible(true);
                lblRespuestaIncorrecta.setVisible(false); 
                btnIgual.setVisible(true); 
                lbl_Por.setVisible(true); txtRespuesta.setVisible(true);
                lbl_NumeroA0.setVisible(false); lbl_NumeroA1.setVisible(false);
                lbl_NumeroA2.setVisible(false); lbl_NumeroA3.setVisible(false);
                lbl_NumeroA4.setVisible(false); lbl_NumeroA5.setVisible(false);
                lbl_NumeroA6.setVisible(false); lbl_NumeroA7.setVisible(false);
                ...
                lbl_NumeroB6.setVisible(false); lbl_NumeroB7.setVisible(false);
                lbl_NumeroB8.setVisible(false); lbl_NumeroB9.setVisible(false);
                btnNumRes0.setVisible(true); btnNumRes1.setVisible(true); btnNumRes2.setVisible(true);
                btnNumRes3.setVisible(true); btnNumRes4.setVisible(true); btnNumRes5.setVisible(true);
                btnNumRes6.setVisible(true); btnNumRes7.setVisible(true); btnNumRes8.setVisible(true);
                btnNumRes9.setVisible(true); btnIgual.setVisible(true); btn_Nuevo.setVisible(true);
                
            }else{
                System.out.println("respuesta INCORRECTA!!!!");
                lblAnuncio.setText("<html><center>!!! RESPUESTA INCORRECTA <br> VERIFICA POR FAVOR ¡¡¡</center></html>");
                lblRespuestaIncorrecta.setVisible(true); btnRegresar.setVisible(true);
                btnIgual.setVisible(true); txtRespuesta.setVisible(true);
